...
```
.claude/agents/client-onboarding-agent.md            # This file (core: inputs, search, present, report, QC)
.claude/agents/client-onboarding-agent/
└── docs/
    └── insert-templates.md                          # Phases 4-10.5: all INSERT/UPDATE SQL templates
```
...
### Phases 4-10.5: Database Insert and Setup

Read `docs/insert-templates.md` for all INSERT/UPDATE SQL templates: clients table, reporting_clients, client_health_scores, leads linking, raw_content for embedding, client_context_cache initialization, auto-link, and Drive folder verification.
