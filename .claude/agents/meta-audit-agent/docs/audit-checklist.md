# Meta Audit Checklist (70 Items) with AdKit Field Mappings
...
**AdKit source:** `adkit_manage entity:"pixels"` -- check that at least one pixel is returned
...
**Severity:** CRITICAL | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"pixels"` -- review `last_fired_time` and pixel event list
...
**AdKit source:** `adkit_manage entity:"pixels"` -- check `is_consolidated_container` or CAPI data source fields
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"pixels"` -- `event_match_quality` field if available
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"pixels"` -- check for deduplication key configuration
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"pixels"` -- review event names
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"accounts"` -- `created_time`, cumulative spend
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"accounts"` -- `business` field
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"accounts"` -- `account_status` field (status 1 = active, 2 = disabled, 9 = in_grace_period)
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"accounts"` -- `spend_cap` field
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"accounts"` -- `timezone_name`
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"accounts"` -- `currency`
...
**Severity:** CRITICAL | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `objective` field
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `daily_budget` vs `adkit_manage entity:"ad_sets"` budget at adset level
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** Cross-reference `targeting` fields from `adkit_manage entity:"ad_sets" action:"get"` across active adsets
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `name` field across all campaigns
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `objective` across all campaigns; `adkit_manage entity:"ad_sets"` -- `targeting` to identify retargeting vs cold
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"campaigns"` objectives + `adkit_manage entity:"ad_sets"` daily_budget
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `buying_type` (AUCTION vs RESERVED)
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `special_ad_categories` field
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `bid_strategy`; `adkit_manage entity:"ad_sets"` -- `bid_amount`
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `status` and `daily_budget`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"campaigns"` count of ACTIVE campaigns + total `daily_budget` across account
...
**AdKit source:** `adkit_manage entity:"accounts"` -- `promoted_object` or product catalog reference
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"custom_audiences"` -- filter for `subtype = WEBSITE`
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"custom_audiences"` -- filter for `subtype = CUSTOM` (email/phone list)
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"custom_audiences"` -- filter for `subtype = LOOKALIKE`
...
**Severity:** CRITICAL | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"custom_audiences"` + `adkit_manage entity:"ad_sets"` targeting
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"custom_audiences"` `approximate_count` + adset daily budget
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ad_sets"` `targeting` -- check `excluded_custom_audiences` on cold-audience adsets
...
**Severity:** HIGH**
**AdKit source:** Compare targeting across cold and retargeting adsets in the same account
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `targeting.interests` array
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `targeting.geo_locations`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `targeting.age_min`, `targeting.age_max`, `targeting.genders`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"custom_audiences"` -- `last_updated_time`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets"` -- check for adsets with minimal targeting restrictions (broad match testing)
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ads"` count per adset_id (status = ACTIVE)
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"creatives"` -- `video_id` not null, or `object_type = VIDEO`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `image_url` not null and `video_id` null
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"results"` at ad level -- `frequency` field (last 7 days)
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"creatives"` -- `call_to_action_type`, `body` text review
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `body` character count
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `title` field
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"creatives"` -- `link_url` or `object_url`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `asset_feed_spec` or `degrees_of_freedom_spec` fields
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"ads"` -- `status` field (check for DISAPPROVED, WITH_ISSUES)
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"results"` -- engagement metrics (post_engagement action type)
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"creatives"` -- `object_type = SHARE` or multi-card creative formats
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ads"` -- `created_time` for ACTIVE ads
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `title` and `body` review across variants
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ad_sets"` -- `learning_phase_outcome` or inferred from low conversion volume + insights
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"results"` at campaign level -- compare daily spend variance
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"results"` at adset level (last 7 days) -- filter for spend = 0 on ACTIVE adsets
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"results"` -- `cost_per_action_type` for lead or purchase events
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"campaigns"` -- count ACTIVE, sum budgets
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `lifetime_budget` + `stop_time`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `spend_cap` vs actual spend from `adkit_manage entity:"results"`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets"` -- `bid_amount` and `optimization_goal` across adsets in same campaign
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `attribution_spec` field (requires per-adset call)
...
**Severity:** CRITICAL | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ad_sets"` -- `optimization_goal` + `promoted_object.custom_event_type`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"creatives"` -- `link_url` contains utm_source=facebook
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"campaigns"` objectives + `adkit_manage entity:"ad_sets"` optimization goals
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"pixels"` -- review event counts. Duplicate events inflate conversion counts.
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"pixels"` -- check for offline event set connections
...
**AdKit source:** `adkit_manage entity:"campaigns"` -- `bid_strategy` = VALUE or adsets with ROAS bid
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"pixels"` -- check for `QUALIFY_LEAD`, `SCHEDULE`, or downstream funnel events
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `publisher_platforms` field (requires per-adset call)
...
**Severity:** HIGH | **EASY-SELL FLAG**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `audience_network_positions` and `publisher_platforms`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `instagram_positions`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- check `facebook_positions` and `instagram_positions` for `reels`
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `facebook_positions` or `instagram_positions` for `story`
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `messenger_positions`
...
**Severity:** MEDIUM**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `placement_customization` field
...
**Severity:** LOW**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `device_platforms` field
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"ads"` -- `status = WITH_ISSUES` or `DISAPPROVED`; `adkit_manage entity:"campaigns"` -- check for policy flags
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"creatives"` -- `body` and `title` review
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"creatives"` -- `link_url` (review destination manually)
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"campaigns"` -- `special_ad_categories` and account-level restrictions
...
**Severity:** CRITICAL**
**AdKit source:** `adkit_manage entity:"accounts"` -- `account_status`, `disable_reason`
...
**Severity:** HIGH**
**AdKit source:** `adkit_manage entity:"ad_sets" action:"get"` -- `targeting.age_min` where content is age-restricted
