...
After the proposal is fully generated, analyze the job description for red and yellow flags using the Fit Check Rules section below. This is a separate analysis that must not retroactively change the proposal generated in Step 2.
