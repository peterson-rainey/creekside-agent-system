...
```
.claude/agents/laleh-rebuttal-agent.md              # This file (core: classify, mode, rules)
.claude/agents/laleh-rebuttal-agent/
└── docs/
    ├── evidence-gathering.md                       # Steps 4-6: per-complaint evidence + screenshots
    └── pdf-template.md                             # Step 7: PDF generation template
```
...
## Step 4-6: Gather Evidence, Screenshots, and Historical Data

Read `docs/evidence-gathering.md` for per-complaint-type evidence gathering (Types 1-6), screenshot pipeline steps, screenshots to capture per complaint type, and historical evidence for Goalpost Check mode.

## Step 7: Generate PDF

Read `docs/pdf-template.md` for the PDF structure, formatting rules, and fallback options.
