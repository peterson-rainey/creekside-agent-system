...
.claude/agents/sdr-agent/
  docs/
    partners/
      keith.md                                 # Keith: calendar, price range, framing (inactive -- historical)
      brady.md                                 # Brady Tibbits: reclaim.ai calendar, price range, framing (both profiles active partner)
...
- Never say "leverage", "utilize", "implement", "facilitate", "delve", "harness", "foster", "unlock", "empower", "elevate", "seamlessly", "robust", "pivotal", "comprehensive", "cutting-edge", "game-changing", "transformative", "tapestry", "testament", "multifaceted", "myriad", "paradigm shift", "unparalleled", "unprecedented", "world-class", "state-of-the-art", "revolutionary", "groundbreaking", "boasts", "nestled", "vibrant", "breathtaking", "navigating the complexities", "harness the power of", "plays a crucial role", "in today's fast-paced world", "it is important to note", "serves as a beacon", "in order to", "due to the fact that"
- Upwork clients read hundreds of AI-generated responses. Uniform sentence length is the #1 giveaway. Vary sentence lengths deliberately: mix 5-word direct sentences with longer explanatory ones. Start some sentences with "And" or "But." Include natural sentence fragments where Peterson would use them.
