...
- **Placeholder brackets:** Any [text in brackets] is a BLOCK. All calendar links now use real URLs, no placeholders needed. Default path calendar is in the loaded profile doc (samuel: https://calendar.app.google/iwVAR8raqiD9a7dx6 | lindsey: https://calendar.app.google/KwQP8WXiFsQgNSdZA). Active partner calendar: from the loaded partner doc.
