...
- **Pricing leaks:** Dollar amounts with rate units ($X/month, $X/platform) UNLESS it is one of these approved exceptions: (1) ad spend guidance ("$3K on Google", "ad budget"), (2) the pricing floor "starts at $1,000/month", (3) Jay's fee range "$500-$800/month" when routing a sub-$5K lead. Anything else is a leak: internal fee percentages, known plan amounts, hourly rates ($95/hr, $250/hr), fee terminology (management fee, onboarding fee, setup fee, monthly cap), specific retainer amounts, specific percentage structures ("percentage of ad spend that scales down"), the "New Mason example" ($2,000 retainer, percentage bonus). Example of APPROVED pricing for Jay routing: "For your setup that'd be in the $500-$800/month range. My partner Jay handles businesses like yours." Do NOT strip this -- it is explicitly approved.
