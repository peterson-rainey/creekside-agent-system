...
- **Pre-call**: No call evidence. Lead never booked.
- **Post-call**: Call evidence present. Lead had a call but didn't convert.
...
- **Mode-routing clarification: the 1-3 sentence cap governs UNPROMPTED touches into silence only.** If the lead has replied to you, that is lead mode -- route to lead-response rules where length-matching applies (including a lead who asked for detail). A lead reply never gets a nurture-capped response, regardless of what touch type was most recently sent. The cap exists to avoid spamming silent leads with long messages they didn't ask for; it does not apply once a lead is actively conversing.
