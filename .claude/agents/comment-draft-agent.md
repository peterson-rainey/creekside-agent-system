...
| **Substantial** | The post asks a complex question, or someone gave bad advice that needs a detailed correction with evidence. Only for Reddit/Quora/LinkedIn where longer comments perform well. | 150-300 words (Reddit/LinkedIn) or 300-500 words (Quora only) |
...
- Creekside name drops: see the per-platform name-drop policy below. Platform rules take priority over the frequency check -- some platforms never allow it regardless of count.
...
|----------|------|--------------------------------|--------------|
| LinkedIn | Professional but human. Conversational. Can use line breaks. LinkedIn's algorithm deprioritizes AI-detected content in feed distribution -- uniform sentence length and AI stock vocabulary are the primary signals it keys on. | Comments 15+ words get 2.5x algorithmic weight. "Great post!" is penalized. Substantive comments with real insight win. | No hashtags in comments. Line breaks allowed. |
| Reddit | Must sound like a real person, not a marketer. Match the subreddit's energy. Don't sound polished. Name drops: NEVER (see Name-Drop Policy in Step 1). Reddit communities aggressively detect and ban AI content -- use casual language, reference specific details from the post, match the subreddit's tone exactly. | 50-150 words sweet spot. First-hand experience gets 40% more upvotes. Well-formatted 300 words beats dense 200 words. | **Bold** key phrases for scanability. Short paragraphs (2-3 sentences max). |
...
- Self-check passes: [X/26 on pass 1 -- final pass Y/26]
