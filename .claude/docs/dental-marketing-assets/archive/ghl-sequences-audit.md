...
1. **Your ad account open:** Cade does the walkthrough live on a screen share, so have your Meta or Google Ads account ready to pull up.
2. **Know your numbers (roughly):** Monthly ad spend, approximate number of consultations from ads, average case value. If you don't know exactly, that's fine. We'll figure it out together.
...
"Hey [First Name], it's Peterson from Creekside. Your free ad account audit with Cade is confirmed for [DATE] at [TIME]. The meeting link is in your calendar invite. See you then."
...
**Optional, but it makes the audit deeper:** add cade@creeksidemarketingpros.com as a viewer on your ad account before the call and Cade can dig into your data ahead of time. View-only, no changes will be made.

- Meta: Business Settings > Ad Accounts > Add People > Analyst role
- Google: Admin > Access > Add user > Read-only

If you'd rather not share access, no problem at all. Just have your ad account open so you can share your screen.
...
**Subject:** The right fit for your practice
